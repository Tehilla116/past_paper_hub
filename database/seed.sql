...
INSERT INTO users (name, email, password_hash, role) VALUES
  ('System Admin', 'admin@zut.edu.zm', '$2a$10$dummyhashdummyhashdummyhashdummyhashdummyhashdummyhash', 'admin'),
  ('Dr. Lecturer', 'lecturer@zut.edu.zm', '$2a$10$dummyhashdummyhashdummyhashdummyhashdummyhashdummyhash', 'lecturer'),
  ('Student User', 'student@zut.edu.zm', '$2a$10$dummyhashdummyhashdummyhashdummyhashdummyhashdummyhash', 'student');
